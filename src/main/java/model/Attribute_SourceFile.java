...
public class Attribute_SourceFile extends Attribute_Info {
            ...
            Constant_Info[] constant_infos) throws Exception
    {
        ...
        attr.length = length;
        attr.name_index = U2.create(is);
        attr.fillForException(attr.name_index, constant_infos, Constant_Utf8_Info.class);
        attr.valueof_name_index = (Constant_Utf8_Info) constant_infos[attr.name_index.getValue()];
        attr.newBytes();
        return attr;
    }
}
