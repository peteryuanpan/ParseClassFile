...
public class Constant_InterfaceMethodref_Info extends Constant_Info {
    ...
    public static Constant_InterfaceMethodref_Info create(InputStream is, U1 tag) throws IOException {
        Constant_InterfaceMethodref_Info ci = new Constant_InterfaceMethodref_Info();
        ci.tag = tag;
