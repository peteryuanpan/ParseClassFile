...
public class Constant_Dynamic_Info extends Constant_Info {
    ...
    public static Constant_Dynamic_Info create(InputStream is, U1 tag) throws IOException {
        Constant_Dynamic_Info ci = new Constant_Dynamic_Info();
        ci.tag = tag;
